// DESIGN: IPSyndicationCollectionFactory is the single deploy point for all
// IPSyndicationCollection contracts. Anyone can deploy a new syndication
...
#[starknet::contract]
pub mod IPSyndicationCollectionFactory {
    ...
    use crate::interface::{IIPSyndicationCollectionFactory, IIP_SYNDICATION_COLLECTION_FACTORY_ID};
    ...
    struct Storage {
        ...
        /// Class hash used to deploy new IPSyndicationCollection instances.
    ...
    /// Emitted each time a new IPSyndicationCollection is deployed via
    /// `deploy_collection`.
    #[derive(Drop, starknet::Event)]
    ...
    fn constructor(ref self: ContractState, collection_class_hash: ClassHash) {
        ...
        self.src5.register_interface(IIP_SYNDICATION_COLLECTION_FACTORY_ID);
        self.collection_class_hash.write(collection_class_hash);
        // deploy_nonce defaults to 0 — no explicit write needed
    }

    #[abi(embed_v0)]
    impl IPSyndicationCollectionFactoryImpl of IIPSyndicationCollectionFactory<ContractState> {
