...
contract MIPEditionsRegistry {
    ...
    /// Deploys a new edition collection owned by the caller. `royaltyBps` sets
    /// the collection's ERC-2981 default royalty with the caller as receiver
    /// (0 = no royalty).
    function createCollection(
        ...
        MIPEditionCollection(collection).initialize(collectionId, msg.sender, name_, symbol_, baseUri_, royaltyBps);
